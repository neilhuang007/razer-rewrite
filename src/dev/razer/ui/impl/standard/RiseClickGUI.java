...
public final class RiseClickGUI extends GuiScreen implements InstanceAccess {
    ...
    public void rebuildModuleCache() {
        ...
        java.util.List<Module> sortedModules = Razer.INSTANCE.getModuleManager().getAll();
...
//        }
    ...
    public boolean activeText() {
        for (final ModuleComponent moduleComponent : Razer.INSTANCE.getStandardClickGUI().getModuleList()) {
