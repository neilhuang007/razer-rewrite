package dev.razer.gg.ui.ingame;
...
//            MC.ingameGUI.renderGameOverlay(partialTicks);
        ...
        InstanceAccess.mc.getTextureManager().bindTexture(Gui.icons);
        GlStateManager.enableBlend();

        if (InstanceAccess.mc.ingameGUI.showCrosshair()) {
            GlStateManager.tryBlendFuncSeparate(775, 769, 1, 0);
            GlStateManager.enableAlpha();
            InstanceAccess.mc.ingameGUI.drawTexturedModalRect(scaledResolution.getScaledWidth() / 2f - 7,
