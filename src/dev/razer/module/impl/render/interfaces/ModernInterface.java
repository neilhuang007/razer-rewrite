...
public class ModernInterface extends Mode<Interface> {
    ...
    public final Listener<Render2DEvent> onRender2D = event -> {
        ...
        if (mc == null || mc.gameSettings.showDebugInfo != 0 || mc.theWorld == null || mc.thePlayer == null || Razer.CLIENT_TYPE != Type.RISE) {
            return;
        }
...
//        this.productSansMedium18.drawStringWithShadow(username, x - nameWidth - 5, y, 0xFFCCCCCC);
        ...
        this.productSansMedium36.drawString(Razer.NAME, 6, 6, logoColor.getRGB());

        NORMAL_POST_BLOOM_RUNNABLES.add(() -> {
            // title in the top left corner of the screen
            this.productSansMedium36.drawString(Razer.NAME, 6, 6, this.getTheme().getFirstColor().getRGB());
        });
