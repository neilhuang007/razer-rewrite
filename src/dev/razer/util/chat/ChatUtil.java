...
public class ChatUtil implements InstanceAccess {
    ...
    private String getPrefix() {
        final String color = Razer.INSTANCE.getThemeManager().getTheme().getChatAccentColor().toString();
        return EnumChatFormatting.BOLD + color + Razer.NAME
