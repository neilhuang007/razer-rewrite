...
public class ConfigFile extends File {
    ...
    public boolean read() {
        ...
        try {
            ...
            if (jsonObject.has("theme")) {
                ...
                theme.ifPresent(configTheme -> Razer.INSTANCE.getThemeManager().setTheme(configTheme));
            }

            // loops through all modules to update their data
            for (final Module module : Razer.INSTANCE.getModuleManager().getAll()) {
    ...
    public boolean write() {
        try {
            ...
            jsonObject.addProperty("theme", Razer.INSTANCE.getThemeManager().getTheme().name());
