...
public class TextBox {
    ...
    public dev.razer.util.font.Font fontRenderer;
    public Color color;
    ...
    public TextBox(final Vector2d position, final dev.razer.util.font.Font fontRenderer, final Color color, final TextAlign textAlign, final String emptyText, final float width, final boolean hideCharacters) {
